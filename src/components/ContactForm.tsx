      ...
      {isSuccess ? (
        ...
        >
          ...
          <div className="space-y-2">
            <h3 className="text-xl font-bold text-zinc-900 dark:text-zinc-50 tracking-tight">Message Received!</h3>
            <p className="text-sm text-zinc-600 dark:text-zinc-400 max-w-md mx-auto leading-relaxed">
              Thanks! Your mock message has been successfully saved in this sandbox environment. In a live system, this would be routed directly to <span className="font-semibold text-zinc-800 dark:text-zinc-200">majeearindam06072002@gmail.com</span>.
            </p>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="space-y-1">
            ...
            <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-normal">
              Have an opening, an idea, or want to discuss a full-stack project? Get in touch.
            </p>
          </div>
